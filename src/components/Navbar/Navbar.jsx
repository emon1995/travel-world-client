...
const Navbar = () => {
    ...
    return (
        <div className="bg-[#283a5ae6] w-screen fixed z-10 shadow-sm text-white">
            <div className="navbar container mx-auto">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 p-2 shadow bg-[#283a5ae6] rounded-box w-52">
                            {navItems}
                        </ul>
                    </div>
                    <a className="btn btn-ghost font-bold normal-case text-2xl">Travel World</a>
                </div>
                <div className="navbar-end ">
                    ...
                    {
                        user?.email && <label tabIndex={0} className="btn btn-ghost btn-circle avatar tooltip tooltip-bottom tooltip-secondary text-white" data-tip={user?.displayName}>
                            <div className="w-10 rounded-full">
                                <img referrerPolicy="no-referrer" src={user && user?.photoURL} />
                            </div>
                        </label>
                    }
